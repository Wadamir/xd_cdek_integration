                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
                    ...
                    <div class="tab-content">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" id="cdek-cdek-log" name="cdek_log">
                                        <?php foreach ($boolean_variables as $key => $variable) { ?>
                                            <option value="<?php echo $key; ?>" <?php if ($cdek_log == $key) { ?> selected="selected" <?php } ?>><?php echo $variable; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    <div class="well well-sm" style="height: 150px; overflow: auto;">
                                        <?php foreach ($stores as $store) { ?>
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="cdek_store[]" value="<?php echo $store['store_id']; ?>" <?php if (isset($cdek_store) && in_array($store['store_id'], $cdek_store)) { ?> checked="checked" <?php } ?>>
                                                    <?php echo $store['name']; ?>
                                                </label>
                                            </div>
                                        <?php } ?>
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" id="cdek-status" name="cdek_status">
                                        <?php foreach (array($text_disabled, $text_enabled) as $key => $value) { ?>
                                            <option value="<?php echo $key; ?>" <?php if ($cdek_status == $key) { ?> selected="selected" <?php } ?>><?php echo $value; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab-data">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="cdek-default-param"><?php echo $entry_default_param; ?></label>
                                <div class="col-sm-10">
                                    <select class="form-control" id="cdek-default-param" name="cdek_default_param[use]">
                                        <?php foreach ($boolean_variables as $key => $variable) { ?>
                                            <option value="<?php echo $key; ?>" <?php if (!empty($cdek_default_param['use']) && $cdek_default_param['use'] == $key) { ?> selected="selected" <?php } ?>><?php echo $variable; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            <?php $style['cdek-default-param_parameters'] = '';
                            if (isset($cdek_default_param) && ($cdek_default_param['use'] == '0' || !$cdek_default_param['use'])) {
                                $style['cdek-default-param_parameters'] = 'style="display:none"';
                            }
                            ?>
                            <div id="cdek-default-param_parameters" class="col-sm-offset-2 col-sm-10" <?php echo $style['cdek-default-param_parameters']; ?>>


                                <div class="form-group required" id="cdek-default-param-type_size">
                                    ...
                                    <div class="col-sm-10 form-inline">
                                        <input class="form-control" id="cdek-default-param-type-size-a" type="text" placeholder="<?php echo $text_short_length; ?>" name="cdek_default_param[size_a]" value="<?php if (!empty($cdek_default_param['size_a'])) { ?><?php echo $cdek_default_param['size_a']; ?><?php } ?>" size="2" /> x
                                        <input class="form-control" type="text" placeholder="<?php echo $text_short_width; ?>" name="cdek_default_param[size_b]" value="<?php if (!empty($cdek_default_param['size_b'])) { ?><?php echo $cdek_default_param['size_b']; ?><?php } ?>" size="2" /> x
                                        <input class="form-control" type="text" placeholder="<?php echo $text_short_height; ?>" name="cdek_default_param[size_c]" value="<?php if (!empty($cdek_default_param['size_c'])) { ?><?php echo $cdek_default_param['size_c']; ?><?php } ?>" size="2" />
                                        <?php if (isset($error['cdek_default_param']['size'])) { ?>
                                            <div class="text-danger"><?php echo $error['cdek_default_param']['size']; ?></div>
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="form-group required">
                                    ...
                                    <div class="col-sm-10 form-inline">
                                        <input class="form-control" id="cdek-default-param-value" type="text" name="cdek_default_param[weight]" value="<?php if (!empty($cdek_default_param['weight'])) { ?><?php echo $cdek_default_param['weight']; ?><?php } ?>" size="1" /> кг.
                                        <?php if (isset($error['cdek_default_param']['weight'])) { ?>
                                            <div class="text-danger"><?php echo $error['cdek_default_param']['weight']; ?></div>
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for=""><?php echo $entry_default_param_work_mode; ?></label>
                                    <div class="col-sm-10">
                                        <select class="form-control" id="cdek-default-param-work-mode" name="cdek_default_param[work_mode]">
                                            <?php foreach ($default_work_mode as $key => $mode) { ?>
                                                <option value="<?php echo $key; ?>" <?php if (!empty($cdek_default_param['work_mode']) && $cdek_default_param['work_mode'] == $key) { ?> selected="selected" <?php } ?>><?php echo $mode; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" id="cdek-cache-on-delivery" name="cdek_cache_on_delivery">
                                        <?php foreach ($boolean_variables as $key => $variable) { ?>
                                            <option value="<?php echo $key; ?>" <?php if ($cdek_cache_on_delivery == $key) { ?> selected="selected" <?php } ?>><?php echo $variable; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" id="cdek-weight-limit" name="cdek_weight_limit">
                                        <?php foreach ($boolean_variables as $key => $variable) { ?>
                                            <option value="<?php echo $key; ?>" <?php if ($cdek_weight_limit == $key) { ?> selected="selected" <?php } ?>><?php echo $variable; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" id="cdek-use-region-russia" name="cdek_use_region_russia">
                                        <?php foreach ($boolean_variables as $key => $variable) { ?>
                                            <option value="<?php echo $key; ?>" <?php if ($cdek_use_region_russia == $key) { ?> selected="selected" <?php } ?>><?php echo $variable; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" id="cdek-use-postcode" name="cdek_use_postcode">
                                        <?php foreach ($boolean_variables as $key => $variable) { ?>
                                            <option value="<?php echo $key; ?>" <?php if ($cdek_use_postcode == $key) { ?> selected="selected" <?php } ?>><?php echo $variable; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <a class="js city-from" <?php if (!$cdek_city_from_id) { ?> style="display:none" <?php } ?>><?php echo $cdek_city_from; ?></a>
                                    <input class="form-control" type="text" id="cdek-city-from" name="cdek_city_from" value="<?php echo $cdek_city_from; ?>" <?php if ($cdek_city_from_id) { ?> style="display:none" <?php } ?> />
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" id="cdek-length-class-id" name="cdek_length_class_id">
                                        <?php foreach ($length_classes as $length_class) { ?>
                                            <option value="<?php echo $length_class['length_class_id']; ?>" <?php if ($length_class['length_class_id'] == $cdek_length_class_id) { ?> selected="selected" <?php } ?>><?php echo $length_class['title']; ?></option>
                                        <?php } ?>
                                    </select>
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" id="cdek-weight-class-id" name="cdek_weight_class_id">
                                        <?php foreach ($weight_classes as $weight_class) { ?>
                                            <option value="<?php echo $weight_class['weight_class_id']; ?>" <?php if ($weight_class['weight_class_id'] == $cdek_weight_class_id) { ?> selected="selected" <?php } ?>><?php echo $weight_class['title']; ?></option>
                                        <?php } ?>
                                    </select>
                        ...
                        <div class="tab-pane" id="tab-tariff">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select id="cdek-work-mode" class="form-control work-mode" name="cdek_work_mode">
                                        <?php foreach ($work_mode as $mode_id => $mode_name) { ?>
                                            <option value="<?php echo $mode_id; ?>" <?php if ($mode_id == $cdek_work_mode) { ?> selected="selected" <?php } ?>><?php echo $mode_name; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <?php $style['cdek-show-pvz_parameters'] = ''; ?>
                            <?php if ($cdek_show_pvz == 0) { ?>
                                <?php $style['cdek-show-pvz_parameters'] = 'style="display:none"'; ?>
                            <?php } ?>
                            ...
                            <table class="table table-striped list">
                                ...
                                <tbody>
                                    <?php $tariff_number = 0; ?>
                                    <?php foreach ($cdek_customer_tariff_list as $tariff_row => $tariff_info) { ?>
                                        <tr id="tariff-<?php echo $tariff_row; ?>">
                                            ...
                                            <td class="col-md-3">
                                                ...
                                                <?php } ?>
                                                <input type="hidden" name="cdek_customer_tariff_list[<?php echo $tariff_row; ?>][sort_order]" value="<?php echo $tariff_info['sort_order']; ?>" class="sort_order" />
                                                <input type="hidden" name="cdek_customer_tariff_list[<?php echo $tariff_row; ?>][tariff_id]" value="<?php echo $tariff_info['tariff_id']; ?>" />
                                                <input type="hidden" name="cdek_customer_tariff_list[<?php echo $tariff_row; ?>][mode_id]" value="<?php echo $tariff_info['mode_id']; ?>" />
                                            </td>
                                            <td class="col-md-3 form-inline">
                                                <?php foreach ($languages as $language) { ?>
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                                                        <input type="text" class="form-control" name="cdek_customer_tariff_list[<?php echo $tariff_row; ?>][title][<?php echo $language['language_id']; ?>]" value="<?php echo (isset($tariff_info['title'][$language['language_id']]) && is_array($tariff_info['title'])) ? $tariff_info['title'][$language['language_id']] : (($language['language_id'] == 1 && is_scalar($tariff_info['title'])) ? $tariff_info['title'] : ''); ?>" />
                                                    </div>
                                                <?php } ?>
                                            </td>
                                            <td class="left">
                                            ...
                                            <td class="left">
                                                ...
                                                <div class="scrollbox" id="geozoneBlock-<?php echo $tariff_row; ?>" style="display: none;">
                                                    ...
                                                    <?php foreach ($geo_zones as $geo_zone) { ?>
                                                        <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                                                        <div class="<?php echo $class; ?>">
                                                            <input type="checkbox" name="cdek_customer_tariff_list[<?php echo $tariff_row; ?>][geo_zone][]" value="<?php echo $geo_zone['geo_zone_id']; ?>" <?php if (isset($tariff_info['geo_zone']) && in_array($geo_zone['geo_zone_id'], $tariff_info['geo_zone'])) echo 'checked="checked"'; ?> />
                                            ...
                                            <td class="left">
                                                ...
                                                <div id="limitBlock-<?php echo $tariff_row; ?>" style="display: none;">
                                                    <table class="form limit">
                                                        <tbody>
                                                            <tr>
                                                                <td><label for="cdek-customer-tariff-list-<?php echo $tariff_row; ?>-min-weight"><span data-toggle="tooltip" title="<?php echo $entry_min_weight_help; ?>"><?php echo $entry_min_weight; ?></span></label></td>
                                                                <td>
                                                                    <input id="cdek-customer-tariff-list-<?php echo $tariff_row; ?>-min-weight" type="text" name="cdek_customer_tariff_list[<?php echo $tariff_row; ?>][min_weight]" value="<?php if (isset($tariff_info['min_weight'])) { ?><?php echo $tariff_info['min_weight']; ?><?php } ?>" size="3" />
                                                            ...
                                                            <tr>
                                                                <td><label for="cdek-customer-tariff-list-<?php echo $tariff_row; ?>-max-weight"><span data-toggle="tooltip" title="<?php echo $entry_max_weight_help; ?>"><?php echo $entry_max_weight; ?></span></label></td>
                                                                <td>
                                                                    <input id="cdek-customer-tariff-list-<?php echo $tariff_row; ?>-max-weight" type="text" name="cdek_customer_tariff_list[<?php echo $tariff_row; ?>][max_weight]" value="<?php if (isset($tariff_info['max_weight'])) { ?><?php echo $tariff_info['max_weight']; ?><?php } ?>" size="3" />
                                                            ...
                                                            <tr>
                                                                <td><label for="cdek-customer-tariff-list-<?php echo $tariff_row; ?>-min-total"><span data-toggle="tooltip" title="<?php echo $entry_min_total_help; ?>"><?php echo $entry_min_total; ?></span></label></td>
                                                                <td>
                                                                    <input id="cdek-customer-tariff-list-<?php echo $tariff_row; ?>-min-total" type="text" name="cdek_customer_tariff_list[<?php echo $tariff_row; ?>][min_total]" value="<?php if (isset($tariff_info['min_total'])) { ?><?php echo $tariff_info['min_total']; ?><?php } ?>" size="3" />
                                                            ...
                                                            <tr class="last">
                                                                <td><label for="cdek-customer-tariff-list-<?php echo $tariff_row; ?>-max-total"><span data-toggle="tooltip" title="<?php echo $entry_max_total_help; ?>"><?php echo $entry_max_total; ?></span></label></td>
                                                                <td>
                                                                    <input id="cdek-customer-tariff-list-<?php echo $tariff_row; ?>-max-total" type="text" name="cdek_customer_tariff_list[<?php echo $tariff_row; ?>][max_total]" value="<?php if (isset($tariff_info['max_total'])) { ?><?php echo $tariff_info['max_total']; ?><?php } ?>" size="3" />
                                        ...
                                        <?php $tariff_number = $tariff_row + 1; ?>
                                    <?php } ?>
                                </tbody>
                            </table>
                        ...
                        <div class="tab-pane" id="tab-discount">
                            ...
                            <table class="table" id="discount">
                                ...
                                <tbody>
                                    <?php $discount_row_number = 0; ?>
                                    <?php if ($cdek_discounts) { ?>
                                        <?php foreach ($cdek_discounts as $discount_row => $discount) { ?>
                                            <tr id="discount-row<?php echo $discount_row; ?>">
                                                <td class="left">
                                                    <input type="text" class="form-control" name="cdek_discounts[<?php echo $discount_row; ?>][total]" value="<?php echo $discount['total']; ?>" size="12" />
                                                ...
                                                <td class="left">
                                                    <select class="form-control" name="cdek_discounts[<?php echo $discount_row; ?>][tax_class_id]">
                                                        <option value="0"><?php echo $text_none; ?></option>
                                                        <?php foreach ($tax_classes as $tax_class) { ?>
                                                            <option value="<?php echo $tax_class['tax_class_id']; ?>" <?php if ($tax_class['tax_class_id'] == $discount['tax_class_id']) { ?> selected="selected" <?php } ?>><?php echo $tax_class['title']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </td>
                                                <td class="left">
                                            ...
                                            <?php $discount_row_number = $discount_row + 1; ?>
                                        <?php } ?>
                                ...
                                <div class="col-sm-10 form-inline">
                                    ...
                                    <select class="form-control" name="cdek_packing_mode">
                                        <?php foreach ($additional_weight_mode as $key => $value) { ?>
                                            <option value="<?php echo $key; ?>" <?php if ($cdek_packing_mode == $key) { ?> selected="selected" <?php } ?>><?php echo $value; ?></option>
                                        <?php } ?>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 form-inline">
                                    <select class="form-control" id="cdek-period" name="cdek_period">
                                        <?php foreach ($boolean_variables as $key => $variable) { ?>
                                            <option value="<?php echo $key; ?>" <?php if ($cdek_period == $key) { ?> selected="selected" <?php } ?>><?php echo $variable; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 form-inline">
                                    <select class="form-control" id="cdek-delivery-data" name="cdek_delivery_data">
                                        <?php foreach ($boolean_variables as $key => $variable) { ?>
                                            <option value="<?php echo $key; ?>" <?php if ($cdek_delivery_data == $key) { ?> selected="selected" <?php } ?>><?php echo $variable; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 form-inline">
                                    <select class="form-control" id="cdek-empty-address" name="cdek_empty_address">
                                        <?php foreach ($boolean_variables as $key => $variable) { ?>
                                            <option value="<?php echo $key; ?>" <?php if ($cdek_empty_address == $key) { ?> selected="selected" <?php } ?>><?php echo $variable; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab-empty">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 form-inline">
                                    <select class="form-control" id="cdek-empty" name="cdek_empty[use]">
                                        <?php foreach ($boolean_variables as $key => $variable) { ?>
                                            <option value="<?php echo $key; ?>" <?php if (!empty($cdek_empty['use']) && $cdek_empty['use'] == $key) { ?> selected="selected" <?php } ?>><?php echo $variable; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div id="cdek-empty_parameters" <?php echo $style['cdek-empty_parameters']; ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 form-inline">
                                        <td>
                                            <input class="form-control" id="cdek-empty-cost" type="text" name="cdek_empty[cost]" value="<?php if (!empty($cdek_empty['cost'])) { ?><?php echo $cdek_empty['cost']; ?><?php } ?>" />
...
<script type="text/javascript"><!--
	...
	var discount_row =<?php echo $discount_row_number; ?>;
	...
	var tariff_row =<?php echo $tariff_number; ?>;
	...
	$('.cdek-tariff').on('change', function(event){
		...
		html += '		<td class="left"><nobr>' + $(option).text() + '</nobr><span class="help"><b><?php echo $column_mode; ?></b>: ' + mode_list[mode_id] + '</span><input class="sort_order" type="hidden" name="cdek_customer_tariff_list[' + tariff_row + '][sort_order]" value="' + sort_orde + '" /><input type="hidden" name="cdek_customer_tariff_list[' + tariff_row + '][tariff_id]" value="' + tariff_id + '" /><input type="hidden" name="cdek_customer_tariff_list[' + tariff_row + '][mode_id]" value="' + mode_id + '" /></td>';
		...
		html += '<input type="text" class="form-control" name="cdek_customer_tariff_list[' + tariff_row + '][title][<?php echo $language['language_id']; ?>]" value="'+tariff_name+'" />';
		html += '</div>';
		<?php } ?>
		html += '		</td>';
		html += '		<td class="left">';
		...
		<?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
		html += '				<div class="<?php echo $class; ?>">';
		html += '				<input type="checkbox" name="cdek_customer_tariff_list[' + tariff_row + '][customer_group_id][]" value="<?php echo $customer_group['customer_group_id']; ?>" />';
		html += '				<?php echo $customer_group['name']; ?>';
		html += '				</div>';
		<?php } ?>
		html += '			</div>';
		...
		<?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
		html += '				<div class="<?php echo $class; ?>">';
		html += '					<input type="checkbox" name="cdek_customer_tariff_list[' + tariff_row + '][geo_zone][]" value="<?php echo $geo_zone['geo_zone_id']; ?>" />';
		html += '					<?php echo $geo_zone['name']; ?>';
		html += '				</div>';
		<?php } ?>
		html += '			</div>';
		...
		html += '				<tbody>';
		html += '					<tr>';
		html += '						<td><label for="cdek-customer-tariff-list-' + tariff_row + '-min-weight"><?php echo $entry_min_weight; ?></label></td>';
		...
		html += '					</tr>';
		html += '					<tr>';
		html += '						<td><label for="cdek-customer-tariff-list-' + tariff_row + '-max-weight"><?php echo $entry_max_weight; ?></label></td>';
		...
		html += '					</tr>';
		html += '					<tr>';
		html += '						<td><label for="cdek-customer-tariff-list-' + tariff_row + '-min-total"><?php echo $entry_min_total; ?></label></td>';
		...
		html += '					</tr>';
		html += '					<tr class="last">';
		html += '						<td><label for="cdek-customer-tariff-list-' + tariff_row + '-max-total"><?php echo $entry_max_total; ?></label></td>';
