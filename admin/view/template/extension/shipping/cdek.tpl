											...
											<div id="limitBlock-<?php echo $tariff_row; ?>" style="display: none;">
												<table class="form limit">
													...
													<tr>
														...
														<td>
															<input id="cdek-custmer-tariff-list-<?php echo $tariff_row; ?>-min-weight" type="text" name="cdek_custmer_tariff_list[<?php echo $tariff_row; ?>][min_weight]" value="<?php if (isset($tariff_info['min_weight'])) { ?><?php echo $tariff_info['min_weight']; ?><?php } ?>" size="3" />
													...
													<tr>
														...
														<td>
															<input id="cdek-custmer-tariff-list-<?php echo $tariff_row; ?>-max-weight" type="text" name="cdek_custmer_tariff_list[<?php echo $tariff_row; ?>][max_weight]" value="<?php if (isset($tariff_info['max_weight'])) { ?><?php echo $tariff_info['max_weight']; ?><?php } ?>" size="3" />
													...
													<tr>
														...
														<td>
															<input id="cdek-custmer-tariff-list-<?php echo $tariff_row; ?>-min-total" type="text" name="cdek_custmer_tariff_list[<?php echo $tariff_row; ?>][min_total]" value="<?php if (isset($tariff_info['min_total'])) { ?><?php echo $tariff_info['min_total']; ?><?php } ?>" size="3" />
													...
													<tr class="last">
														...
														<td>
															<input id="cdek-custmer-tariff-list-<?php echo $tariff_row; ?>-max-total" type="text" name="cdek_custmer_tariff_list[<?php echo $tariff_row; ?>][max_total]" value="<?php if (isset($tariff_info['max_total'])) { ?><?php echo $tariff_info['max_total']; ?><?php } ?>" size="3" />
