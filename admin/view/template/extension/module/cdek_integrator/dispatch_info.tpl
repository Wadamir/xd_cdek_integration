<div class="heading dispatch-info">
	...
	<div class="buttons">
		...
		<nobr class="help sync"><?php echo $text_last_synchronization; ?> <strong><?php echo $last_exchange; ?></strong></nobr>
	</div>
</div>
<div class="content">
	<table class="form">
		<tbody>
			<tr>
				<td><?php echo $label_order_number; ?></td>
				<td>
					<?php echo $dispatch_info['order_id']; ?>
				</td>
			</tr>
			<tr>
				<td><?php echo $label_receipt; ?></td>
			...
			<tr>
				<td><?php echo $label_shipment_date; ?></td>
				<td><?php echo $date; ?></td>
			</tr>
			<tr>
				<td><?php echo $label_cdek_number; ?></td>
				<td>
			...
			<tr>
				<td><?php echo $label_act_number; ?></td>
				<td>
			...
			<tr>
				<td><?php echo $label_tariff; ?></td>
				<td><?php echo $tariff['title']; ?></td>
			</tr>
			<?php if ($dispatch_info['seller_name']) { ?>
				<tr>
					<td><?php echo $label_seller_name; ?><span class="help"><?php echo $label_seller_help; ?></span></td>
					<td><?php echo $dispatch_info['seller_name']; ?></td>
				</tr>
			<?php } ?>
			<?php if (!empty($delivery_recipient_cost)) { ?>
				<tr>
					<td><?php echo $label_additional_cost; ?></td>
				...
				<td>
					<?php if ($delivery_cost) { ?>
						...
						<?php if (!empty($delivery_last_change)) { ?>
							<span class="help">
								<?php echo $text_delivery_last_change; ?>
							</span>
						<?php } ?>
					<?php } else { ?>
						<a class="js sync-row"><?php echo $text_sync; ?></a>
			...
			<tr class="item-slider row-status">
				...
				<td>
					<strong><?php echo $status['title']; ?></strong>&nbsp;&nbsp;<a class="js" data-title="<?php echo $label_status_history; ?>">History changes</a>
					<div class="reason-status"><?php if (!empty($reason_status)) { ?><?php echo $reason_status; ?><?php } ?></div>
					...
					<table class="list">
						...
						<tbody>
							<?php foreach ($status_history as $row => $status_info) { ?>
								<tr <?php if ($row == 0) { ?> class="row-status" <?php } ?>>
								...
								<tbody>
									<?php foreach ($call_history['good'] as $row => $call_history_info) { ?>
										<tr class="row-status">
											...
											<td class="left"><?php echo $call_history_info['date_delivery']; ?></td>
										</tr>
									<?php } ?>
								</tbody>
							</table>
			...
			<tbody>
				<?php foreach ($package_info['items'] as $package_item) { ?>
					<tr>
						...
						<td class="left"><?php echo $package_item['amount']; ?></td>
