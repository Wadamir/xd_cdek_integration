		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<table class="list table table-bordered table-hover">
					<thead>
					<tr>
						<td class="right"><a href="<?php echo $sort_order; ?>" <?php if ($sort == 'o.order_id') { ?> <?php echo 'class="' . $order . '"'; ?><?php } ?>><?php echo $column_order_id; ?></a></td>
						<td class="left"><a href="<?php echo $sort_customer; ?>" <?php if ($sort == 'customer') { ?> <?php echo 'class="' . $order . '"'; ?><?php } ?>><?php echo $column_customer; ?></a></td>
						<td class="left"><a href="<?php echo $sort_status; ?>" <?php if ($sort == 'status') { ?> <?php echo 'class="' . $order . '"'; ?><?php } ?>><?php echo $column_status; ?></a></td>
						<td class="right"><a href="<?php echo $sort_total; ?>" <?php if ($sort == 'o.total') { ?> <?php echo 'class="' . $order . '"'; ?><?php } ?>><?php echo $column_total; ?></a></td>
						<td class="left"><a href="<?php echo $sort_date_added; ?>" <?php if ($sort == 'o.date_added') { ?> <?php echo 'class="' . $order . '"'; ?><?php } ?>><?php echo $column_date_added; ?></a></td>
