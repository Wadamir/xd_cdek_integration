        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <table class="list table" style="table-layout: fixed;">
                    <thead>
                        <tr>
                            <td class="left"><a href="<?php echo $sort_order_id; ?>" <?php if ($sort == 'o.order_id') { ?> class="<?php echo $order; ?>" <?php } ?>><?php echo $column_order_id; ?></a></td>
                            <td class="left"><a href="<?php echo $sort_dispatch_number; ?>" <?php if ($sort == 'd.dispatch_number') { ?> class="<?php echo $order; ?>" <?php } ?>><?php echo $column_dispatch_number; ?></a></td>
                            <td class="left"><a href="<?php echo $sort_act_number; ?>" <?php if ($sort == 'o.act_number') { ?> class="<?php echo $order; ?>" <?php } ?>><?php echo $column_act_number; ?></a></td>
                            <td class="left"><a href="<?php echo $sort_date; ?>" <?php if ($sort == 'd.date') { ?> class="<?php echo $order; ?>" <?php } ?>><?php echo $column_dispatch_date; ?></a></td>
                            <td class="left"><a href="<?php echo $sort_city_from; ?>" <?php if ($sort == 'o.city_name') { ?> class="<?php echo $order; ?>" <?php } ?>><?php echo $column_city_from; ?></a></td>
                            <td class="left"><a href="<?php echo $sort_city_to; ?>" <?php if ($sort == 'o.recipient_city_name') { ?> class="<?php echo $order; ?>" <?php } ?>><?php echo $column_city_to; ?></a></td>
                            <td class="left"><a href="<?php echo $sort_status; ?>" <?php if ($sort == 'o.status_id') { ?> class="<?php echo $order; ?>" <?php } ?>><?php echo $column_status; ?></a></td>
                            <td class="left"><a href="<?php echo $sort_total; ?>" <?php if ($sort == 'o.delivery_cost') { ?> class="<?php echo $order; ?>" <?php } ?>><?php echo $column_delivery_cost; ?></a></td>
